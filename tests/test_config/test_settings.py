...
"""
        ...
        monkeypatch.setenv("INSPECT_WANDB_MODELS_FILES", '["env-file1.txt", "env-file2.txt"]')
...
"""
        ...
        monkeypatch.setenv("INSPECT_WANDB_MODELS_FILES", '["env-file.yaml"]')
